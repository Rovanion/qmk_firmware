...
#define PLVR 2 // Stenography through plover
 ...
 * |--------+------+------+------+------+------|      |         |      |------+------+------+------+------+--------|
 * | Super  |   A  |   S  |   D  |   F  |   G  |------|         |------|   H  |   J  |   K  |   L  |   Ö  |   Ä    |
 * |--------+------+------+------+------+------|Shift+|         | PLVR |------+------+------+------+------+--------|
 * | LShift |   Z  |   X  |   C  |   V  |   B  |Insert|         |      |   N  |   M  |   ,  |   .  |   -  |   Å    |
 * `--------+------+------+------+------+-------------'         `-------------+------+------+------+------+--------'
 *   |LCtrl |  '"  | Left | Right| LAlt |                                       | AltGr|   ]  |  Up  | Down |   '  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                    ,-----------------.       ,---------------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_LCTL,   KC_QUOT,    KC_LEFT,  KC_RGHT,  KC_LALT,
                                         ALT_T(KC_APP), KC_HOME,
                                                              KC_END,
                    MT(MOD_LCTL,KC_SPC),MT(MOD_LALT,KC_ENT),  KC_EQL,
        ...
        TG(PLVR),     KC_N,    KC_M,     KC_COMM,  KC_DOT,  CTL_T(KC_SLSH),  NO_APOS,
                      KC_RALT, KC_RBRC,  KC_UP,    KC_DOWN, KC_EQL,
        MO(2),        CTL_T(KC_ESC),
        KC_PGUP,
